...
export default () => (
    <StayConnectedWrapper>
        <ul>
            <li>
                <a href="http://www.linkedin.com/in/janetkulyk" title="LinkedIn">
                    <SocIcon>
            ...
            <li>
                <a href="mailto:janetkulyk@yahoo.com" title="Email">
                    <SocIcon>
            ...
            <li>
                <a href="https://www.facebook.com/janetkulyk" title="Facebook">
                    <SocIcon>
                    <svg viewBox="0 0 512 512">
            ...
            <li>
                <a href="https://twitter.com/zhannett" title="Twitter">
                    <SocIcon>
                        <svg viewBox="0 0 512 512">
            ...
            <li>
                <a href="https://plus.google.com/110317853968895582194/" title="GooglePlus">
                    <SocIcon>
                        <svg viewBox="0 0 512 512">
            ...
            <li>
                <a href="https://github.com/zhannett" title="Github">
                    <SocIcon>
                        <svg viewBox="0 0 512 512">
